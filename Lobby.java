/**
 * [Lobby.java]
 * this is the program for the client lobby window
 * @author Andrew Wu
...
public class Lobby {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Lobby window = new Lobby("127.0.0.1", 5000, "","");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 */
	public Lobby(String ip, int port, String name, String selectedClass) {
		...
		public void run() {
			...
			while (gameStarted == false) {
				try {
					...
					joinGameWindow.getErrorLabel().setText("Error! Game is either full or doesn't exist.");
				}
			}
			frame.dispose();
